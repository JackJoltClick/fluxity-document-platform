-- Migration: Create document_vendors table for vendor matching
-- This table tracks vendor matches for documents with confidence scores

-- Create the document_vendors table
