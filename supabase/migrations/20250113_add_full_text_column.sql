-- Migration: Add full_text column for document search and display
-- This adds a column to store the complete extracted text from documents
...
-- Optional: Create a function to search documents by text
